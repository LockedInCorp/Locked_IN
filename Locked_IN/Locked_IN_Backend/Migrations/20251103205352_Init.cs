        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    friendssince_timestamp = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "TestDescription1", 3, 1, false, false, 5, 1500, "CS2 Legends" },
                    { 2, "TestDescription2", 1, 2, true, true, 5, 800, "LoL Rookies" },
                    { 3, "TestDescription3", 4, 3, false, false, 5, 2000, "Valorant Pros" },
                    { 4, "TestDescription4", 2, 2, true, false, 6, null, "Casual Gamers" }
                });

...
{
    /// <inheritdoc />
    public partial class FixChatSequences : Migration
    {
        /// <inheritdoc />
        ...
        {
            // Note: Sequences are kept even if migration is rolled back
            // Uncomment below if you want to remove sequences on rollback
            // migrationBuilder.Sql("DROP SEQUENCE IF EXISTS chat_id_seq CASCADE;");
            // migrationBuilder.Sql("DROP SEQUENCE IF EXISTS chatparticipant_chatparticipant_id_seq CASCADE;");
            // migrationBuilder.Sql("DROP SEQUENCE IF EXISTS message_id_seq CASCADE;");
        }
    }
}
